...
$qry="select * from health_post where id='$page_id'";
...
<?php
			include('includes/connect.php');
			mysqli_set_charset($conn,'utf8');
			$qry="select * from health_post order by 1 desc limit 0,5";
			$query=mysqli_query($conn,$qry);
...
?>
			<li>
				<div class="media"><a class="media-left" href="health_page.php?id=<?php echo "$id"; ?>"><img src="images/<?php echo $image ?>"></a>
