...
<div class="container">
  ...
  <div class="header"  style="padding:15px;font-size:25px;text-align:center;background-color:#343a40!important"><h2 style="color:white">Real Estate Post</h2></div>
  <div class="header"><h4 align="left" style="padding:5px;background-color:white"><span><i class="fas fa-home" style="margin:5px"></i></span><a href="index.php">Home > <a href="index.php?viewrp=viewrp">All Real Estate Posts</a><h3 align="right" ><a href="logout.php"><h3 style="color:red;margin-right:15px"><button style="font-size:24px;color:red;cursor:pointer">Admin Logout <span><i class="fas fa-sign-out-alt"></i></span></button></h3></a></h4></h3></div>
   <div class="row">
...
<form action="estate_insert_post.php" method="POST" enctype="multipart/form-data">
...
{	$id=uniqid();
	...
	$query="INSERT INTO `realestate_post`(`id`, `title`, `image`, `content`, `date`) VALUES ('$id','$title','$img_name','$content','$date')";
