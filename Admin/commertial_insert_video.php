...
<body>
<div class="container">
<div class="header"  style="padding:15px;font-size:25px;text-align:center;background-color:#343a40!important"><h2 style="color:white">Commercial Video</h2></div>
  <div class="header"><h4 align="left" style="padding:5px;background-color:white"><span><i class="fas fa-home" style="margin:5px"></i></span><a href="index.php">Home > <a href="index.php?viewcov=viewcov">All Commercial Videos</a><h3 align="right" ><a href="logout.php"><h3 style="color:red;margin-right:15px"><button style="font-size:24px;color:red;cursor:pointer">Admin Logout <span><i class="fas fa-sign-out-alt"></i></button></h3></a></h4></h3></div>
  <div class="row">
...
$query = "insert into commertial_video(id,title,link,descr,date) values('$id','$title','$link','$desc','$date')";
