...
<body>
     <div class="header" style="padding:20px;font-size:25px;text-align:center;background-color:#343a40!important"><h2 style="color:white">Agriculture Post</h2></div>
    <div class="header" align="left" style="background-color:#FAFEC2;padding:5px;font-size:20px"><span><i class="fas fa-home" style="margin:5px"></i></span><a href="index.php">Home > <a href="index.php?viewhagp=viewhagp">All Agriculture Posts</a></div>
	<div class="container"> 
<?php
include('../includes/connect.php');
    
$edit_id = @$_GET['edit'];
$qry = "select * from agriculture_post where id = '$edit_id'";
...
while($row=mysqli_fetch_array($query))
{
	...
	<div class="col-sm-2">
	  ...
	  <div class="col-sm-8" style="padding:15px">
        <form action="agriculture_post_edit.php?edit_form=<?php echo $edit_id1; ?>" method="post" enctype="multipart/form-data">
    <table border="10" align="center" style="border-collapse:collapse" class="table-bordered">
        ...
        <td align="right"><b>Post Content:</b></td>
         <td><textarea name="content" cols="60" rows="17"><?php echo $content; ?></textarea> </td>  
        </tr>
...
$update_query="update agriculture_post set title = '$post_title', image = '$post_image', content = '$post_content', date = '$post_date' where id = '$update_id'";  
      
      if(mysqli_query($conn, $update_query))
      {
          echo"<script>alert('Post has Been Updated..')</script>";
          echo"<script>window.open('index.php?viewagp=viewagp','_self')</script>";
