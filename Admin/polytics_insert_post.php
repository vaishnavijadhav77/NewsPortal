...
<form action="polytics_insert_post.php" method="POST" enctype="multipart/form-data">
...
{	$id=uniqid();
	...
	$query="INSERT INTO `polytics_post`(`id`, `title`, `image`, `content`, `date`) VALUES ('$id','$title','$img_name','$content','$date')";
