...
<body>
      <div class="header" style="padding:20px;font-size:25px;text-align:center;background-color:#343a40!important"><h2 style="color:white">Real Estate Post</h2></div>
    <div class="header" align="left" style="background-color:#FAFEC2;padding:5px;font-size:20px"><span><i class="fas fa-home" style="margin:5px"></i></span><a href="index.php">Home > <a href="index.php?viewrp=viewrp">All Real Estate Posts</a></div>
	<div class="container"> 
<?php
include('../includes/connect.php');
    
$edit_id = @$_GET['edit'];
$qry = "select * from realestate_post where id = '$edit_id'";
...
while($row=mysqli_fetch_array($query))
{
	...
	<div class="col-sm-2">
	  ...
	  <div class="col-sm-8" style="padding:15px">
        <form action="estate_post_edit.php?edit_form=<?php echo $edit_id1; ?>" method="post" enctype="multipart/form-data">
...
$update_query="update realestate_post set title = '$post_title', image = '$post_image', content = '$post_content', date = '$post_date' where id = '$update_id'";  
      
      if(mysqli_query($conn, $update_query))
      {
          echo"<script>alert('Post has Been Updated..')</script>";
          echo"<script>window.open('index.php?viewrp=viewrp','_self')</script>";
