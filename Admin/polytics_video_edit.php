...
<body>
     <div class="header" style="padding:20px;font-size:25px;text-align:center;background-color:#343a40!important"><h2 style="color:white"> Politics Video</h2></div>
    <div class="header" align="left" style="background-color:#FAFEC2;padding:5px;font-size:20px"><span><i class="fas fa-home" style="margin:5px"></i></span><a href="index.php">Home > <a href="index.php?viewpv=viewpv">All Politics Videos</a></div>
	<div class="container">    
<?php
include('../includes/connect.php');
    
$edit_id = @$_GET['edit'];
$qry = "select * from polytics_video where id = '$edit_id'";
...
?>
	...
	<div class="col-sm-2">
	  ...
	  <div class="col-sm-8" style="padding:15px">
        <form action="polytics_video_edit.php?edit_form=<?php echo $edit_id1; ?>" method="post" enctype="multipart/form-data">
...
$update_query="update polytics_video set title = '$video_title', link = '$video_link', descr= '$video_descr', date = '$video_date' where id = '$update_id'";  
