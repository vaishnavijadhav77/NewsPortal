...
?>
			<li>
				<div class="media"><a class="media-left" href="poly_page.php?id=<?php echo "$id"; ?>"><img src="images/<?php echo $image ?>"></a>
...
?>
      ...
      <div class="col-lg-4 col-md-4 col-sm-4">
        <aside class="right_content">
          <div class="single_sidebar">
            <h2><span>राजकारण व्हिडिओ</span></h2>
            <ul class="spost_nav">
<?php
											include('includes/connect.php');
											mysqli_set_charset($conn,'utf8');
											$query = "select * from polytics_video order by id desc";
