...
$qry="select * from agriculture_post where id='$page_id'";
 ...
 <div class="col-lg-4 col-md-4 col-sm-4">
        <div class="latest_post">
          ...
          <div class="latest_post_container">
			...
			include('includes/connect.php');
			mysqli_set_charset($conn,'utf8');
			$qry="select * from agriculture_post order by 1 desc limit 0,5";
			$query=mysqli_query($conn,$qry);
			...
			?>
			<li>
				<div class="media"><a class="media-left" href="agriculture_page.php?id=<?php echo "$id"; ?>"><img src="images/<?php echo $image ?>"></a>
